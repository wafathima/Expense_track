    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          />
          <svg
            className="pointer-events-none absolute -right-8 -top-8 h-56 w-56 opacity-[0.09]"
            viewBox="0 0 100 100"
          >
            <circle cx="50" cy="50" r="46" fill="none" stroke="#D8B84A" strokeWidth="2" />
            <circle cx="50" cy="50" r="37" fill="none" stroke="#D8B84A" strokeWidth="1" />
          ...
          <div className="relative">
            <p className="mb-2 text-xs font-semibold uppercase tracking-[0.28em] text-[#8FBF9F]">
              Personal Finance Ledger
            </p>
            <h1
              className="text-4xl font-semibold text-[#F5F1E4] md:text-5xl"
              style={{ fontFamily: "'Fraunces', Georgia, serif" }}
            >
              Expense Tracker
            </h1>
            <p className="mt-3 max-w-md text-[#BFDAC7]">
              Track and manage your daily expenses — every rupee, accounted for.
            </p>
          </div>
        </div>
